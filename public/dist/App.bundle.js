...
function typeAhead(search) {
  ...
  //the .on is shortened from .addEventListener
  searchInput.on('input', function () {
    var _this = this;

    //if there is no value, quit from running
    if (!this.value) {
  ...
  searchInput.on('keyup', function (e) {
    //if they aren't pressing up/down/enter we don't care.
...
function loadPlaces(map) {
  ...
  _axios2.default.get('/api/stores/near?lat=' + lat + '&lng=' + lng).then(function (res) {
    ...
    //add pins for location of places
